...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    layout: Attribute.Enumeration<['singleImage', 'video', 'youtube']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    youtube: Attribute.Component<'youtube-video.youtube-video'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    mainButton: Attribute.Component<'buttons.project-button'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    secondaryButtons: Attribute.Component<'buttons.project-button', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
